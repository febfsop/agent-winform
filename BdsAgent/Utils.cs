...
namespace BdsAgent
{
    ...
    public class ParamFinger
    {
        ...
        public string hashedTemplate { get; set; }
    ...
    class Utils
    {
        ...
        string coba = System.IO.Path.GetDirectoryName(System.Reflection.Assembly.GetEntryAssembly().Location);*/
        string exeDirectory = "./refrences";
        ...
        public int InitLibrary(string operation)
        {
            ...
            try
            {
                ...
                if (pDll == IntPtr.Zero)
                {
                    bool fl = NativeMethods.FreeLibrary(this.pDll);
                    Console.WriteLine("Result Code -1, Library Not Exist");
